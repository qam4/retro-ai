...
- [ ] 1. Implement AgentManifest and AgentRegistry
  - [ ] 1.1 Create `python/retro_ai/training/registry.py` with `AgentManifest` dataclass
  ...
  - [ ] 1.2 Implement `AgentRegistry` class
...
- [ ] 3. Implement publish command
  - [ ] 3.1 Implement `AgentPublisher` class
  ...
  - [ ] 3.2 Add `publish` subcommand to CLI
    - Arguments: model_path, --eval, --config, --profile, --video (optional), --description (optional)
    - _Requirements: 3.1, 3.2_

- [ ] 4. Implement download command
  - [ ] 4.1 Implement `AgentDownloader` class
    - `download(agent_id, output_dir)`: load manifest, run `gh release download`
    - _Requirements: 5.1, 5.2, 5.3_

  - [ ] 4.2 Add `download` subcommand to CLI
    - Arguments: agent_id, --output (optional, default ".")
    - _Requirements: 5.1_

- [ ] 5. Add leaderboard CLI command
  - [ ] 5.1 Add `leaderboard` subcommand to CLI
    - No arguments, regenerates from all manifests
    - _Requirements: 4.1, 4.2, 4.3, 4.4_

- [ ] 6. Catalog existing agents
  - [ ] 6.1 Create manifest for discrete Course Automobile agent
  ...
  - [ ] 6.2 Create manifest for multi-discrete Course Automobile agent
    - Build from `output/course_automobile_md/config.yaml`, `eval/eval_results.json`, `summary.json`
    - _Requirements: 1.1, 1.2_

  - [ ] 6.3 Generate initial leaderboard
