...
class TestExceptionHierarchy:
    ...
    def test_initialization_error(self):
        assert issubclass(retro_ai.InitializationError, retro_ai.RetroAIError)

    def test_invalid_action_error(self):
        assert issubclass(retro_ai.InvalidActionError, retro_ai.RetroAIError)

    def test_state_error(self):
        assert issubclass(retro_ai.StateError, retro_ai.RetroAIError)

    def test_configuration_error(self):
        assert issubclass(retro_ai.ConfigurationError, retro_ai.RetroAIError)
